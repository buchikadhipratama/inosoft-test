...
<head>
    ...
    <title>Inosoft Vehicle | Sales</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="card card-primary">
                                <div class="card-header" style="background-color: #D00412">
                                ...
                                <form action="/penjualan/kasir" enctype="form-data" id="form-order" method="POST">
                                  ...
                                  <div class="tabel-kasir">
                                    <div class="table-transaksi" style="overflow: auto; max-height:300px;text-align:center">
                                      <table id="myTable" class="" style="width: 100%">
                                        <thead style="text-align: center; ">
                                          <tr>
                                            <th class="tabel menu" style="position:sticky; top:0; background-color:#fff">Nama</th>
                                    ...
                                    <div style="margin: 10px">
                                      ...
                                      {{-- <span>
                                        <div style="width:100%;background-color: green; color:#fff; text-align: center;">Rp.
                                          1000.000,-</div>
                                      </span> --}}
                                    </div>
                                  </div>
                                ...
                                <div class="card-footer" style="text-align: center">
                                  <button class="btn btn-warning tombol" onclick="orderProcess();">Proses Pesanan</button>
                                </div>
                              </div>
                        </div>
                        <!-- /.col -->
